...
The package handles a limited set of introductory-level scenarios and requires the user to explicitly specify the outcome and predictor variables when needed, ensuring that no incorrect assumptions are made about variable roles.
